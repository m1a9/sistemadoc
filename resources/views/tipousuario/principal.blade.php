<div class="card card-primary">
     <div class="card-header" style="border: 1px solid #3c8dbc;background-color: #3c8dbc; color: white;">
        <h3 class="card-title">Gestión de tipo de usuario</h3>
 ...
 <div class="card" v-if="diveditar" style="border: 1px solid #00a65a;">
	...
	<div class="card-body" style="border: 1px solid #00a65a;">
		...
		<div class="card-footer bg-transparent">
			<button class="btn btn-info" v-on:click="updatetipousu()">Guardar cambio</button>
...
<div class="card" style="border: 1px solid #3c8dbc;">
	<div class="card-header" style="border: 1px solid #3c8dbc;background-color: #3c8dbc; color: white;">
		<h3 class="card-title">Lista de tipo de usuario</h3>
		<div class="card-tools">
			<input type="text" class="form-control form-control-sm" v-model="buscar" v-on:keyup="buscartipousu" placeholder="Buscar...">
		</div>
	</div>
		...
		<table class="table table-hover table-bordered table-striped">
			<thead>
				<tr>
					...
					<th style="border:1px solid #ddd;padding: 5px; width: 70%;">Tipo de usuario</th>
					<th style="border:1px solid #ddd;padding: 5px; width: 20%;">Gestión</th>
				</tr>
			</thead>
			<tbody>
				<tr v-for="cat, key in tipousus">
					...
					<td style="border:1px solid #ddd;font-size: 14px; padding: 5px;">
						<center>
						<a href="#" class="btn btn-warning btn-sm" v-on:click.prevent="editartipousu(cat)" data-placement="top" data-toggle="tooltip" title="Editar tipo de usuario">
							<i class="fa fa-edit"></i></a>
               			<a href="#" class="btn btn-danger btn-sm" v-on:click.prevent="borrartipousu(cat)" data-placement="top" data-toggle="tooltip" title="Borrar tipo de usuario">
