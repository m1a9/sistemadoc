<div class="card card-primary">
     <div class="card-header" style="border: 1px solid #3c8dbc;background-color: #3c8dbc; color: white;">
        <h3 class="card-title">Gestión de Cargo</h3>
    ...
    <div class="card-body" style="border: 1px solid #3c8dbc;">
        <div class="form-group">
          	<button type="button" class="btn" style="background-color: #3c8dbc; color: white;" @click.prevent="nuevo()"><i class="fa fa-plus-square-o" aria-hidden="true" ></i> Nuevo Cargo</button>
        </div>
	</div>
</div>
 <div class="card" v-if="diveditar" style="border: 1px solid #00a65a;">
	...
	<div class="card-body" style="border: 1px solid #00a65a;">
		...
		<div class="card-footer bg-transparent">
			<button class="btn btn-info" v-on:click="updatecargo()">Guardar cambio</button>
...
<div class="card" style="border: 1px solid #3c8dbc;">
	<div class="card-header" style="border: 1px solid #3c8dbc;background-color: #3c8dbc; color: white;">
		...
		<div class="card-tools">
			<input type="text" class="form-control form-control-sm" v-model="buscar" v-on:keyup="buscarcargo" placeholder="Buscar...">
		</div>
	</div>
		...
		<table class="table table-hover table-bordered table-striped">
			<thead>
				<tr>
					...
					<th style="border:1px solid #ddd;padding: 5px; width: 70%;">Cargo</th>
					<th style="border:1px solid #ddd;padding: 5px; width: 20%;">Gestión</th>
				</tr>
			</thead>
			<tbody>
				<tr v-for="cat, key in cargos">
					...
					<td style="border:1px solid #ddd;font-size: 14px; padding: 5px;">
						<center>
						<a href="#" class="btn btn-warning btn-sm" v-on:click.prevent="editarcargo(cat)" data-placement="top" data-toggle="tooltip" title="Editar Cargo">
							<i class="fa fa-edit"></i></a>
               			<a href="#" class="btn btn-danger btn-sm" v-on:click.prevent="borrarcargo(cat)" data-placement="top" data-toggle="tooltip" title="Borrar Cargo">
